...
<head>
    ...
    <link rel="stylesheet" href="fauclty-schedule.css">
...
<body>
    ...
    <div class="scheduleContainer">
        <h1 class="tableHeader">Faculty Schedule</h1>
        ...
        <div class="cpeTable" id="cpeTable">
            <table class="schedule">
                ...
                <?php
                    ...
                    $sql = "SELECT professors.prof_nm, schedule.d_of_week, schedule.start, schedule.end
                            FROM professors
                            INNER JOIN schedule ON professors.prof_id = schedule.prof_id
                            WHERE professors.dept_id = 1";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>" . $row["prof_nm"] . "</td>";
                            echo "<td>" . $row["d_of_week"] . "</td>";
    ...
    <script src="faculty-schedule.js"></script>
</body>
</html>
