...
<head>
    ...
    <link rel="stylesheet" href="loginstyle-staff.css">
...
<body>
    ...
    <form action="connect-staff.php" method="post">
        ...
        <div class="loginFrame">
            ...
            <?php if (isset($_GET['error'])) {?>
                <div style="text-align: center; margin-top: 10px; color: red;">Invalid Staff Number or Password</div>
            <?php } ?>

            <div class="input-box">
                <input type="text" id="staffnumber" name="staff_id" placeholder="Staff Number" required>
    ...
    <script src="loginscript-staff.js"></script>
</body>
</html>
